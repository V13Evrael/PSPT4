package es.studium.EjercicioClase1.EnvioCorreo;
...
public class EnvioCorreo {
	public static void main(String[] args) {
		...
		String asunto = "José Manuel Platero";
	...
	private static void enviarConGMail(String destinatario, String asunto, String cuerpo) {
		...
		try {
			...
			transport.connect("grupostudium-com.correoseguro.dinaserver.com", remitente, "N0sJyMNX");
